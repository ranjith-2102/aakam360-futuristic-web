          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {statistics.map((stat, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="liquid-card p-8 text-center gpu-accelerated"
        ...
        <div className="container mx-auto">
          ...
          <div className="pillars-grid">
            {pillars.map((pillar, index) => {
              ...
              return (
                <Card key={index} className="liquid-card p-6 text-center group expand-card gpu-accelerated">
        ...
        <div className="container mx-auto">
          ...
          <div className="logo-carousel">
            {[...alliances, ...alliances].map((alliance, index) => {
              ...
              return (
                <div key={index} className="logo-item gpu-accelerated">
