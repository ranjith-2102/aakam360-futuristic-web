    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="/lovable-uploads/3fbef525-52f8-4216-bc7c-b4b1418c3c8f.png" 
        ...
        <div className="container mx-auto px-6 text-center relative z-30">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold heading-display mb-8 text-white fade-in-up">
              Aakam<span className="text-blue-400">360</span>
            </h1>
            <p className="text-xl md:text-2xl lg:text-3xl heading-lg mb-6 text-white/90 fade-in-up" style={{animationDelay: '0.2s'}}>
              Innovate and Inspire
            </p>
            <p className="text-lg md:text-xl body-large mb-12 text-white/80 max-w-3xl mx-auto leading-relaxed fade-in-up" style={{animationDelay: '0.4s'}}>
