                    ...
                    <div className={index % 2 === 0 ? 'order-2' : 'order-1 md:order-2'}>
                      <div className={`bg-muted/20 p-12 rounded-xl border border-border/50 transition-transform duration-500 ${
                        ...
                        <div className="text-center">
                          <IconComponent className="w-20 h-20 mx-auto mb-6 text-accent" />
                ...
                {pillars.map((pillar, index) => {
                  ...
                  return (
                    <div key={index} className="relative">
                      <div className="w-16 h-16 bg-accent/20 rounded-full flex items-center justify-center shadow-lg parallax-float border border-accent/30">
